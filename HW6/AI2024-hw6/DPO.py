...
def DPO_train(args, output_dir):
    ...
    output_file = os.path.join(submission_dir, f"DPO_{args.model_name.split('/')[1]}_numEpochs{args.num_epochs}_beta{args.beta}.json")
    # output_file = os.path.join(submission_dir, f"DPO_{args.model_name.split('/')[1]}_{args.beta}.json")
